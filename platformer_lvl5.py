def levelFive(timeTaken):
    ...
    platforms.append(Platform(size[0]/4, size[1]/7, size, yellow))
    ...
    platforms.append(Platform(size[0]/4, size[1]/3, size, yellow))
    platforms.append(Platform(size[0]/7, size[1]/3 * 2, size, yellow))
    platforms.append(Platform(size[0]/6, size[1]/8 * 5, size, yellow))
    platforms.append(Platform(size[0]/3, size[1]/7 * 4, size, yellow))
    platforms.append(Platform(size[0]/5, size[1]/5 * 2, size, yellow))
    platforms.append(Platform(size[0]/4, size[1]/5 * 4, size, yellow))
    platforms.append(Platform(size[0]/5 * 2, size[1]/4 * 3, size, yellow))
    platforms.append(Platform(size[0]/5, size[1]/7, size, blue))
    platforms.append(Platform(size[0]/3, size[1]/8 * 7, size, yellow))
    platforms.append(Platform(size[0]/4, size[1]/8 * 7, size, green))
    enemies = []
    enemies.append(Enemy(size[0]/5, size[1]/2, 'right', size))
    enemies.append(Enemy(size[0]/6, size[1]/5, 'right', size))
    enemies.append(Enemy(size[0]/5, size[1]/4, 'right', size))
    enemies.append(Enemy(size[0]/3, size[1]/5 * 3, 'right', size))
    enemies.append(Enemy(size[0]/4, size[1]/3, 'right', size))
    enemies.append(Enemy(size[0]/7, size[1]/3 * 2, 'right', size))
    enemies.append(Enemy(size[0]/6, size[1]/8 * 5, 'right', size))
    enemies.append(Enemy(size[0]/3, size[1]/7 * 4, 'right', size))
    enemies.append(Enemy(size[0]/5, size[1]/5 * 2, 'right', size))
    enemies.append(Enemy(size[0]/4, size[1]/5 * 4, 'right', size))
    enemies.append(Enemy(size[0]/5 * 2, size[1]/4 * 3, 'right', size))
    enemies.append(Enemy(size[0]/3, size[1]/8 * 7, 'right', size))
    playerx = 0
    playery = 0
